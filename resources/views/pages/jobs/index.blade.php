                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="job-list-three d-flex h-100 w-100">
                                    <div class="main-wrapper h-100 w-100">
                                        <a href="{{ route('home.jobs.show', $job->id) }}" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                                        <div class="list-header d-flex align-items-center">
                                            <a href="{{ route('home.jobs.show', $job->id) }}" class="logo"><img src="images/logo/media_22.png" alt="" class="lazy-img m-auto" style=""></a>
                                            <div class="info-wrapper">
                                                <a href="{{ route('home.jobs.show', $job->id) }}" class="title fw-500 tran3s">{{ $job->title }}</a>
                                        ...
                                        <div class="d-sm-flex align-items-center justify-content-between mt-auto">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="fw-500 client-status">{{ $job->status }}</span>
                                                <a href="{{ route('home.jobs.show', $job->id) }}" class="job-duration fw-500">{{ $job->type }}</a>
                                            </div>
                                            <a href="{{ route('home.jobs.show', $job->id) }}" class="apply-btn text-center tran3s xs-mt-20">APPLY</a>
                                        </div>
                                    </div>
                                </div> <!-- /.job-list-three -->
                            </div>
