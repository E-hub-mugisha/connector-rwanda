...
<style>
    ...
    .svcs-banner .crumbs a {
        color: rgba(255, 255, 255, .8);
        font-weight: 500;
        transition: color var(--transition);
    }

    .svcs-banner .crumbs a:hover {
        color: #fff;
    }
    ...
    .svcs-pagination nav > div,
    .svcs-pagination .pagination {
        display: flex;
        align-items: center;
        gap: 6px;
        list-style: none;
    ...
    .svcs-pagination a:hover {
        background: var(--clr-sage-lt);
        border-color: var(--clr-sage-md);
    }

    .svcs-pagination .active span,
    .svcs-pagination span[aria-current="page"] {
        background: var(--clr-forest);
        border-color: var(--clr-forest);
        color: #fff;
    }

    .svcs-pagination .disabled span {
        color: var(--clr-muted);
        opacity: .5;
    }
...
<div class="svcs-page">
    ...
    <!-- ── BANNER ─────────────────────────────────── -->
    <div class="svcs-banner">
        <div class="container-lg">
            <div class="crumbs">
                <a href="{{ route('home') }}">Home</a>
                <span>/</span>
                <span style="color:#fff;">@yield('title')</span>
            </div>
            <h1>@yield('title')</h1>
            <p>Browse every service on the platform and connect with a vetted provider in minutes.</p>
        </div>
    </div>

    <!-- ── LAYOUT ─────────────────────────────────── -->
    <section class="svcs-layout">
        <div class="container-lg">
            <div class="svcs-grid-wrap">
                ...
                <aside>
                    ...
                    <div class="collapse d-lg-block" id="filterPanelCollapse">
                        <div class="filter-panel">
                            ...
                            <div class="fp-foot">
                                <a href="{{ route('home.services') }}" class="btn-apply-filter">Apply Filter</a>
                            </div>
                        </div>
                    </div>
                </aside>
                ...
                <div>
                    <div class="results-top">
                        <div class="count">{{ $services->total() }} <span>service{{ $services->total() == 1 ? '' : 's' }} found</span></div>
                    ...
                    <div class="services-grid">
                        ...
                        <div class="empty-state">
                            <div class="icon-wrap">
                                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="7" /><path d="m21 21-4.3-4.3" /></svg>
                            </div>
