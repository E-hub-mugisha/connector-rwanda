...
<style>
    ...
    .filter-cat-item.is-active > .fc-row {
        background: var(--clr-sage-lt);
    }

    .filter-cat-item.is-active > .fc-row a {
        color: var(--clr-forest);
        font-weight: 700;
    }
    ...
    <div class="cat-banner">
        <div class="container-lg">
            <div class="crumbs">
                ...
                <span>/</span>
                <span style="color:#fff;">{{ $scategory->name }}</span>
            </div>
            <h1>{{ $scategory->name }}</h1>
            <p>We deliver fast, reliable and vetted service providers ready to help with {{ strtolower($scategory->name) }}.</p>
        </div>
    </div>
            ...
            <div class="cat-grid-wrap">
                    ...
                    <div class="collapse d-lg-block" id="filterPanelCollapse">
                        <div class="filter-panel">
                            ...
                            <ul class="filter-cat-list" id="filterCatList">
                                ...
                                <li class="filter-cat-item {{ $scateg->slug === $scategory->slug ? 'is-active' : '' }}">
                                    <div class="fc-row">
                            ...
                            <div class="fp-foot">
                                <a href="{{ route('home.service_by_category', ['category_slug' => $scategory->slug]) }}" class="btn-apply-filter">Apply Filter</a>
                            </div>
                        </div>
                    </div>
                </aside>
                ...
                <div>
                    <div class="results-top">
                        <div class="count">{{ $scategory->services->count() }} <span>service{{ $scategory->services->count() == 1 ? '' : 's' }} found</span></div>
                    ...
                    <div class="services-grid">
                        ...
                        <div class="empty-state">
                            ...
                            <h4>No services in this category yet</h4>
                            <p>Try browsing another category or check back soon.</p>
                        </div>
                        @endif
                    </div>
                </div>
