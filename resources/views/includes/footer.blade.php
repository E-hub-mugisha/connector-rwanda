        ...
        <div class="inner-wrapper">
            <div class="row">
                <div class="col-lg-2 col-md-3 footer-intro mb-15">
                    ...
                    <img src="{{ asset('asset/images/lazy.svg')}}" data-src="{{ asset('asset/images/shape/shape_28.svg')}}" alt="" class="lazy-img mt-80 sm-mt-30 sm-mb-20">
                    <!-- logo -->
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4 mb-20">
                    <h5 class="footer-title">Easy Way​</h5>
                    <ul class="footer-nav-link style-none">
                        <li><a href="{{ route('home.services')}}">Browse Services</a></li>
                        <li><a href="{{route('home.service_provider')}}">Service Providers</a></li>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 mb-20">
                    ...
                    <ul class="footer-nav-link style-none">
                        ...
                        <li><a href="{{route('policy')}}">Cookie policy</a></li>
                    </ul>
                </div>
                <div class="col-lg-4 mb-20 footer-newsletter">
                    <h5 class="footer-title">Newsletter</h5>
                    <p>Join & get important new regularly</p>
                    <form action="{{ route('Subscriptions.store') }}" method="POST" class="d-flex">
                        @csrf
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 order-lg-1 mb-15">
                    <ul class="d-flex style-none bottom-nav justify-content-center justify-content-lg-start">
                        <li><a href="{{ route('terms') }}">Privacy & Terms.</a></li>
