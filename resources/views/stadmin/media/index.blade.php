                            ...
                            <div class="col-md-2 mb-4">
                                <div class="card shadow-sm">
                                    ...
                                    <div class="media-container">
                                        @if($media->type === 'image')
                                        <img src="{{ asset('image/services/' . $media->file_path) }}" class="card-img-top media-image" alt="Service Image">
                                        ...
                                        <div class="media-options">
                                            <form action="{{ route('service-media.destroy', $media->id ) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm delete-btn" data-id="{{ $media->id }}">
