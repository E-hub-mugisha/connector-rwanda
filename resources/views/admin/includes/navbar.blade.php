    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                @endforeach
                <a class="dropdown-item text-center small text-gray-500" href="{{route('admin.bookings')}}">Show All Bookings</a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                @foreach(\App\Models\Contact::latest()->take(5)->get() as $contacts)
                <a class="dropdown-item d-flex align-items-center" href="{{route('admin.messageDetail',$contacts->id)}}">
                    ...
                    <div class="font-weight-bold">
                        ...
                        <div class="small text-gray-500">{{$contacts->name}} | {{$contacts->created_at}}</div>
                    </div>
                </a>
                @endforeach
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <center>
                                <img class="img-profile rounded-circle" src="{{asset('admin/img/undraw_profile.svg')}}" name="aboutme" width="140" height="140" ></a>
                                <h3 class="media-heading">{{ auth()->user()->name }}</h3>
                                <span><strong>Location: </strong></span>
                                <span class="label label-warning">{{ auth()->user()->location }}</span>
                            </center>
                            <hr>
                            <center>
