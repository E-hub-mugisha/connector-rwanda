...
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background: #6B9080;">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.sub_category')}}">Sub Categories</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.create_service')}}">Add Services</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{route('admin.ProviderFeedback')}}">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Service Provider Feedback</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{route('admin.ProviderRatings')}}">
            <i class="fas fa-fw fa-chart-area"></i>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{route('admin.newsletterSubscriptions.index')}}">
            <i class="fas fa-fw fa-user"></i>
