                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <select class="form-control" name="service_provider_id" id="service_provider_id">
                            <option value="{{ $sprovider->id }}">{{ $sprovider->sprovider_name }}</option>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select class="form-control" name="service_category_id" id="service_category_id">
                            <option value="{{ $service->service_category_id }}">{{ $service->category->name }}</option>
                    ...
                    <div class="col-md-4 form-group">
                        <label for="service_category" value="{{ __('service_category') }}">Service sub category</label>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select class="form-control" name="discount_type">
                            <option value="{{ $service->discount_type }}">{{ $service->discount_type }}</option>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select class="form-control" name="featured">
                            <option value="{{ $service->featured }}">{{ $service->featured }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{asset('assets/images/products')}}/{{$service->image}}" width="60" />
                    </div><!-- End .form-group -->
                    <div class="form-group">
                        ...
                        <img src="{{asset('assets/images/products/thumbnails')}}/{{$service->thumbnail}}" width="60" />
