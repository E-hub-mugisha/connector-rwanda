                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="address-block-one text-center mb-40 wow fadeInUp">
                                <div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="<?php echo e(asset('asset/images/icon/icon_57.svg')); ?>" alt=""></div>
                        ...
                        <div class="col-md-4">
                            <div class="address-block-one text-center mb-40 wow fadeInUp">
                                <div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="<?php echo e(asset('asset/images/icon/icon_58.svg')); ?>" alt=""></div>
                                <h5 class="title">Contact Info</h5>
                                <p>Give us call at <br><a href="tel:+250791957955" class="call">+250 791 957 955</a></p>
                            </div> <!-- /.address-block-one -->
                        </div>
                        <div class="col-md-4">
                            <div class="address-block-one text-center mb-40 wow fadeInUp">
                                <div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="<?php echo e(asset('asset/images/icon/icon_59.svg')); ?>" alt=""></div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/connector/public_html/hiletask/resources/views/pages/contact.blade.php ENDPATH**/ ?>