...
<section class="faq-section position-relative pt-30 lg-pt-10">
    <div class="container">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="FcollapseOne" class="accordion-collapse collapse" aria-labelledby="FheadingOne" data-bs-parent="#accordionTwo">
                                <div class="accordion-body">
                                    <p>Connector is a simplified online booking system and management tool empowering service providers with the best digital solutions that enable them anywhere to find jobs, sell services easily, manage their business efficiently, and allow customers to book an appointment online anytime for free. </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
        ...
        <div class="text-center border-bottom pb-150 lg-pb-50 mt-60 lg-mt-40 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
            ...
            <a href="<?php echo e(route('home.contact')); ?>" class="btn-one">Contact Us</a>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/connector/public_html/hiletask/resources/views/pages/faq.blade.php ENDPATH**/ ?>