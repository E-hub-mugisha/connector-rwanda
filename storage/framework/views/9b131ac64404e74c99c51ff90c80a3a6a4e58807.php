...
<div class="inner-banner-one position-relative">
    <div class="container">
        <div class="position-relative">
            <div class="row">
                <div class="col-lg-8">
                    <h3>Dive into a world of<span> inspiration, creativity, and imagination. </span></h3>
                    <p class="text-lg text-white mt-40 md-mt-30 mb-50 md-mb-30">Our blog is a platform for stories, ideas, and innovations that spark your creativity and motivate you to pursue your passions.</p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/connector/public_html/hiletask/resources/views/pages/blog.blade.php ENDPATH**/ ?>