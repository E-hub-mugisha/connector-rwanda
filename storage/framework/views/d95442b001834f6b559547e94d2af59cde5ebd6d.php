<?php $__env->startSection('title', 'Providers By Category'); ?>
                ...
                <div class="position-relative">
                    <div class="upper-filter d-flex justify-content-between align-items-start align-items-md-center mb-20">
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <div class="total-job-found md-mt-10">All <span class="text-dark fw-500"></span> Providers found</div>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="short-filter d-flex align-items-center">
                                <div class="text-dark fw-500 me-2">Short:</div>
                                <select name="sortby" id="sortby" class="nice-select">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/connector/public_html/hiletask/resources/views/service_provider/serviceProviderByCategory.blade.php ENDPATH**/ ?>