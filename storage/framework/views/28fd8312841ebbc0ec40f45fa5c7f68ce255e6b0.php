        ...
        <div class="row">
            <div class="col-lg-7 order-lg-last">
                <div class="ps-xxl-4 wow fadeInRight">
                    ...
                    <a href="<?php echo e(route('home.services')); ?>" class="btn-one lg mt-50 md-mt-30">Get a service</a>
                </div>
            </div>
            <div class="col-lg-5 col-md-11 m-auto order-lg-first">
                <div class="img-data position-relative pe-xl-5 me-xl-5 md-mt-50">
                    <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('asset/images/assets/image7.jpg')); ?>" alt="" class="lazy-img img01">
...
<section class="how-it-works position-relative bg-dark pt-110 lg-pt-80 pb-110 lg-pb-70">
    <div class="container">
        <div class="title-one text-center mb-65 lg-mb-40">
            <h2 class="text-white">How it’s <span class="position-relative">work? <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('asset/images/shape/shape_07.svg')); ?>" alt="" class="lazy-img shapes shape"></span></h2>
        </div>

        <div class="row justify-content-center">
            <div class="col-xxl-3 col-lg-4 col-md-6">
                <div class="card-style-two text-center mt-25 wow fadeInUp">
                    <div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('asset/images/icon/icon_08.svg')); ?>" alt="" class="lazy-img"></div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 m-auto">
                <div class="card-style-two text-center position-relative arrow mt-25 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('asset/images/icon/icon_09.svg')); ?>" alt="" class="lazy-img"></div>
    ...
    <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('asset/images/shape/shape_08.svg')); ?>" alt="" class="lazy-img shapes shape_01">
    <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('asset/images/shape/shape_09.svg')); ?>" alt="" class="lazy-img shapes shape_02">
</section>
<!-- /.how-it-works -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <ul class="btn-group style-none d-flex flex-wrap justify-content-center justify-content-lg-end">
                        ...
                        <li class="ms-2"><a href="<?php echo e(route('register')); ?>" class="btn-four">Post a job</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/connector/public_html/hiletask/resources/views/pages/about.blade.php ENDPATH**/ ?>