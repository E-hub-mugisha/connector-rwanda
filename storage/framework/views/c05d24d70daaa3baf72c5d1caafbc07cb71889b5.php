...
<table class="table table-hover table-bordered mt-3">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo e($app->user->name ?? 'N/A'); ?></td>
            <td>
            ...
            <td class="d-flex gap-1">
                ...
                <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#viewApplicantModal<?php echo e($app->id); ?>">
                    <i class="fa fa-eye"></i>
                </button>

                <!-- Accept/Reject -->
                <?php if($app->status == 'pending'): ?>
                <form action="<?php echo e(route('admin.applications.accept', $app->id)); ?>" method="POST" class="mr-1">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('admin.applications.reject', $app->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\connector\git\hiletask\resources\views/admin/applications/index.blade.php ENDPATH**/ ?>