        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-danger alert-dismissible fade show">
                        ...
                        <button type="button" class="btn-close" data-bs-bs-dismiss="alert"></button>
                    </div>
                    <?php endif; ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex gap-1">
                                        <!-- Edit Button -->
                                        <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editJobModal<?php echo e($job->id); ?>">
                                            Edit
                                        </button>
                                        <!-- View Button -->
                                        <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#viewJobModal<?php echo e($job->id); ?>">
                                            View
                                        </button>
                                        <!-- Update Status Button -->
                                        <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#updateStatusModal<?php echo e($job->id); ?>">
                                            Update Status
                                        </button>
                                        <!-- Job Applicants Button -->
                                        <a class="btn btn-primary" href="<?php echo e(route('provider.jobs.applications', $job->id)); ?>">
                                            Job Applicants <i class="fa fa-users"></i> <?php echo e($job->applications->count()); ?>

                                        </a>
                                        <!-- Delete Button -->
                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteJobModal<?php echo e($job->id); ?>">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
            ...
            <div class="modal fade" id="updateStatusModal<?php echo e($job->id); ?>" tabindex="-1">
                <div class="modal-dialog">
                    <form action="<?php echo e(route('provider.jobs.updateStatus', $job->id)); ?>" method="POST" class="modal-content">
                        <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="editJobModal<?php echo e($job->id); ?>" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <form action="<?php echo e(route('provider.jobs.update', $job->id)); ?>" method="POST" class="modal-content">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="modal-body">
                            <?php echo $__env->make('stadmin.jobs.form', ['job' => $job], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="modal-footer">
            ...
            <div class="modal fade" id="deleteJobModal<?php echo e($job->id); ?>" tabindex="-1">
                <div class="modal-dialog">
                    <form action="<?php echo e(route('provider.jobs.destroy', $job->id)); ?>" method="POST" class="modal-content">
                        <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="addJobModal" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <form action="<?php echo e(route('provider.jobs.store')); ?>" method="POST" class="modal-content">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="modal-body">
                            <?php echo $__env->make('stadmin.jobs.form', ['job' => null], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
...
<?php echo $__env->make('layouts.staradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\connector\git\hiletask\resources\views/stadmin/jobs/index.blade.php ENDPATH**/ ?>