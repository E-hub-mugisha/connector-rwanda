                        ...
                        <div class="step pricing-card-one border-0 mt-25" id="step1">
                            <div class="row">
                                <div class="col-lg-5 col-md-5"><!-- Service Name and Provider Info -->
                                    ...
                                    <p class="text-body fw-bold mb-2" style="font-size: 18px; font-weight:700;">Provider Name: <span class="text-muted mb-2"><?php echo e($service->provider->sprovider_name); ?></span></p>
                                ...
                                <div class="col-lg-7 col-md-7">
                                    <div class="row booking-dash-body"><!-- User Info Inputs -->
                                        ...
                                        <div class="col-md-6 dash-input-wrapper mb-30">
                                            <input type="text" class="form-control" id="names" name="names" value="<?php echo e(Auth::user()->name); ?>" placeholder="Enter your Names" required>
                                        </div>
                                        <div class="col-md-6 dash-input-wrapper mb-30">
                                            <input type="text" class="form-control" id="email" name="email" value="<?php echo e(Auth::user()->email); ?>" placeholder="Enter your email" required>
                                        </div>
                                        <div class="col-md-6 dash-input-wrapper mb-30">
                                            <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo e(Auth::user()->phone); ?>" placeholder="Enter your phone number" required>
                                        </div>
                                        <div class="col-md-6 dash-input-wrapper mb-30">
                                            <input type="text" class="form-control" id="location" name="location" value="<?php echo e(Auth::user()->location); ?>" placeholder="Enter your location" required>
                                        </div>
                                        <div class="col-md-12">
