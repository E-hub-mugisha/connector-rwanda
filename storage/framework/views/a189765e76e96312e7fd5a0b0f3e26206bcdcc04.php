...
<div class="row mb-3">
    <div class="col-md-6">
        ...
        <select name="company_id" class="form-control" required>
            <?php $__currentLoopData = \App\Models\ServiceProvider::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($company->id); ?>" <?php echo e(isset($job) && $job->company_id==$company->id ? 'selected' : ''); ?>>
                    <?php echo e($company->sprovider_name); ?>
...
<?php /**PATH D:\connector\git\hiletask\resources\views/admin/jobs/form.blade.php ENDPATH**/ ?>