...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> | connector</title>

    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('asset/images/fav-icon/fav-connector.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('asset/images/fav-icon/fav-connector.png')); ?>">
...
<body id="page-top">
    ...
    <script src="<?php echo e(asset('admin/vendor/jquery/jquery.min.js')); ?>">
    </script>
...
</html><?php /**PATH /home4/connector/public_html/hiletask/resources/views/layouts/app.blade.php ENDPATH**/ ?>