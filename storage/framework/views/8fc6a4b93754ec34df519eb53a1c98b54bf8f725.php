                ...
                <nav class="navbar navbar-expand-lg p0 ms-lg-5 ms-3 order-lg-2">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav align-items-lg-right">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('home.jobs')); ?>" role="button">Jobs</a>
                            </li>
                            <li class="nav-item dropdown">
...
</header> <!-- /.theme-main-menu --><?php /**PATH D:\connector\git\hiletask\resources\views/includes/header.blade.php ENDPATH**/ ?>