...
<?php $__env->startSection('title', 'Blogs in ' . $category); ?>
...
<div class="inner-banner-one position-relative">
    <div class="container">
        <div class="position-relative">
            <div class="row">
                <div class="col-lg-8">
                    <h3>Explore blogs in <span><?php echo e($category); ?></span></h3>
                    <p class="text-lg text-white mt-40 md-mt-30 mb-50 md-mb-30">Discover insights, stories, and creativity under the <strong><?php echo e($category); ?></strong> category.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="heading text-center mb-3">
                        <h2 class="title"><?php echo e($category); ?> Blogs</h2>
                        <p class="title-desc">Latest articles in <?php echo e($category); ?></p>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <article class="blog-meta-two mt-15 xs-mt-20 wow fadeInUp">
                        <figure class="post-img m0">
                            <a href="<?php echo e(route('home.blog_detail', ['blog_slug' => $blog->slug])); ?>" class="w-100 d-block">
                                <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('image/blog/' . $blog->image)); ?>" alt="" class="lazy-img w-100 tran4s" style="height: 300px; width: 100%; object-fit: cover;">
                            </a>
...
<?php endif; ?>
            ...
            <div class="text-center explore-btn sm-mt-50">
                <a href="<?php echo e(route('home.blogs')); ?>" class="btn-six">Explore More</a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/connector/public_html/hiletask/resources/views/pages/blogCategory.blade.php ENDPATH**/ ?>